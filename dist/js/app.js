...
$(function() {
    ...
    app.controller("logDownloadCtrl", function ($scope, $http, loginForwardURL){
        ...
        var pageControlUpdate = function(){
            ...
            $scope.logItems = $scope.logAllItems.slice(startIndex, startIndex + parseInt($scope.itemNumOfPage));
        };
    ...
    app.controller("systemInfoCtrl", function ($scope, $http, loginForwardURL){
        ...
        var updateAPKFile = function(files){
            ...
            xhr.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    console.log("Upload apk file successfully");
                    $scope.systemInfo.systemApkDownUrl = JSON.parse(this.response).urls;
                    $scope.$apply();
                }
            };
        };
